...
@section('content')
    <div class="d-inline-flex p-2 bg-body-dark text-white">
        <p class="h6"><a href="{{ route('autors.index') }}">Autores</a> ->Edição</p>
    </div>
    <form action="{{ route('autors.update', $autor) }}" method="POST">
        ...
        <div class="bg-light w-50 p-2 mt-6 container-fluid justify-center border border-dark">
            <h1 class="h6 text-center">ATUALIZAÇÃO DE AUTOR</h1>
            ...
            <div class="form-check">
                ...
                <div class="form-check form-check-inline mb-4">
                    <input class="form-check-input" type="radio" id="espirito" name="espirito" value="0"
                        {{ old('espirito', $autor->espirito) == 0 ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="espirito" name="espirito" value="1"
                        {{ old('espirito', $autor->espirito) == 1 ? 'checked' : '' }}>
