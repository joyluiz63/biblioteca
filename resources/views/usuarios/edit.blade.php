        ...
        <div class="bg-light p-2 mt-6 container-fluid justify-center border border-dark">
            ...
            <div class="row">
                <div class="col-sm-7 mb-3 text-center">
                    ...
                    <input type="text" class="form-control" name="nome" value="{{ isset($usuario->nome) ? $usuario->nome : old('nome') }}">
                </div>

                <div class="col-sm-2 mb-3 text-center">
                    <label for="nascimento">Data de Nascimento</label>
                    <input type="date" class="form-control" name="nascimento" value="{{ isset($usuario->nascimento) ? $usuario->nascimento : old('nascimento') }}">
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 mb-3 text-center">
                    ...
                    <input type="text" class="form-control" name="rua" value="{{ isset($usuario->rua) ? $usuario->rua : old('rua') }}">
                </div>

                <div class="col-sm-2 mb-3 text-center">
                    <label for="numero">Número</label>
                    <input type="text" class="form-control" name="numero" value="{{ isset($usuario->numero) ? $usuario->numero : old('numero') }}">
                </div>

                <div class="col-sm-4 mb-3 text-center">
                    <label for="complemento">Complemento</label>
                    <input type="text" class="form-control" name="complemento" value="{{ isset($usuario->complemento) ? $usuario->complemento : old('complemento') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 mb-3 text-center">
                    ...
                    <input type="text" class="form-control" name="bairro" value="{{ isset($usuario->bairro) ? $usuario->bairro : old('bairro') }}">
                </div>

                <div class="col-sm-6 mb-3 text-center">
                    <label for="cidade">Cidade</label>
                    <input type="text" class="form-control" name="cidade" value="{{ isset($usuario->cidade) ? $usuario->cidade : old('cidade') }}">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 mb-4 text-center">
                    ...
                    <input type="email" class="form-control" name="email" value="{{ isset($usuario->email) ? $usuario->email : old('email') }}">
                </div>
            </div>
